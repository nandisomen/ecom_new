                ...
                <div class="main_div col-lg-6 col-md-8 col-11 mx-auto row-gap-5 p-lg-5">
                    ...
                    <form action="customer_registration.php" method="post" enctype="multipart/form-data">
                        ...
                        <div class="roup">
                            ...
                            <input type="password" name="c_password" id="c_password" class="form-control" min="6" required>
                        ...
                        <div class="roup">
                            ...
                            <input type="password" name="c_confirm_password" id="c_confirm_password" class="form-control" min="6" required>
